...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        @endif
        @if (Request::is('groups') || Request::is('group/*'))
            <script type="text/javascript" src="{{ url('js/group.js') }}" defer></script>
        @endif
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous" defer></script>
    </head>
    <body class="container-fluid">
        <div class="row h-100" id = "main-container">
            <header class="col-md" id="sticky-leftbar" style="padding:0;">
                <div class="sticky-top">
                    @yield('leftbar')
                </div>
            </header>
            <main class="col-md" style="padding:0; height:100%">
                @if(!Request::is('notifications') && !Request::is('home') && !Request::is('group/*') &&!Request::is('recover-password'))
            ...
            <aside class="col-md d-sm" id="sticky-rightbar" style="padding:0;">
                <div class="sticky-top">
                    @yield('rightbar')
                </div>
            </aside>
