...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2 , 'Tangram': 3, 'UnitCube': 4 , 'Prism': 5, 'Cilinder': 6};
    ...
    initMaterials() {
        ...
        // wood color with low espaclar
        this.material4.setAmbient(0.5, 0.3, 0.0, 1.0);
        this.material4.setDiffuse(0.5, 0.3, 0.0, 1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Wood Specular': 3, 'Custom': 4 };
    }
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.displayAmbientLight, this.displayAmbientLight, this.displayAmbientLight, 1.0);
        this.lights[0].update();
        this.lights[1].update();
